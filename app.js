...
function renderQuestionAnswers(){
  ...
  '<fieldset>' +
	'<legend class = "question-render"></legend>' +
	'<div class="answer-choices">' +
	'<input aria-label="answer choice" type="radio" name="answer" id="ans-a" class="answer-inputs" value=' + state.questions[state.questionIndex].answers[0].correct + '>' +
	'<label for="answer-a" id="answer-a"></label><br>' +
	'<input aria-label="answer choice" type="radio" name="answer" id="ans-b" class="answer-inputs" value=' + state.questions[state.questionIndex].answers[1].correct + '>' +
	'<label for="answer-b" id="answer-b"></label><br>' +
	'<input aria-label="answer choice" type="radio" name="answer" id="ans-c" class="answer-inputs" value=' + state.questions[state.questionIndex].answers[2].correct + '>' +
	'<label for="answer-c" id="answer-c"></label><br>' +
	'<input aria-label="answer choice" type="radio" name="answer" id="ans-d" class="answer-inputs" value=' + state.questions[state.questionIndex].answers[3].correct + '>' +
